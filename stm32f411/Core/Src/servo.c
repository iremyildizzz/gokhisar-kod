...
static int16_t s_pan_cdeg  = SERVO_PAN_HOME_CDEG;
static int16_t s_tilt_cdeg = SERVO_TILT_HOME_CDEG;
...
{
    s_pan_cdeg  = SERVO_PAN_HOME_CDEG;
    s_tilt_cdeg = SERVO_TILT_HOME_CDEG;
    s_enabled   = false;
    s_limited   = false;
